...
const TaskPage = () => {
  return (
    <div className="bg-[#121214] flex flex-col overflow-y-auto">
      <div className="fixed top-0 left-0 right-0 h-[200px] bg-[#121214] z-10 mb-20">
        <h1 className="font-extrabold text-[#767676] text-[25px] mx-auto text-center mt-[50px]">
          ROCKET
        </h1>
        <h1 className="mx-auto text-[14px] font-normal text-[#767676] text-center mt-[1px]">
