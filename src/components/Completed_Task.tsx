...
const Completed_Task = () => {
  return (
    <div className="bg-[#121214] flex flex-col">
      <div className="fixed top-0 left-0 right-0 h-[230px] bg-[#121214]">
        <h1 className="font-extrabold text-[#767676] text-[25px] text-center mx-auto mt-[61px]">
          ROCKET
        </h1>
        <h1 className="mx-auto text-[14px] font-normal text-center text-[#767676] mt-[19px]">
