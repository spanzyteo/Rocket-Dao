  ...
  return (
    <div className="bg-[#121214] flex flex-col overflow-y-auto">
      <div className="h-[340px] fixed top-0 left-0 right-0 bg-[#121214]">
        <h1 className="mt-[20px] font-custom font-bold text-center text-[30px] text-[#FFFFFF] mx-auto">
          Invite Friends
        </h1>
        <div className="mt-[5px] h-[200px] w-[90%] lg:w-[380px] mx-auto border border-[#3D3D3D] rounded-lg flex flex-col items-center ">
          <h1 className="mt-[16px] text-[#FFFFFF] font-normal text-[15px] font-custom">
            Affiliate Earnings
          </h1>
          ...
          <div className="w-[148px] h-[47px] bg-[#131313] text-[#FFFFFF] flex items-center justify-center rounded-lg">
      ...
      {referral && (
        <>
          <div className="overflow-y-auto mt-[330px] pb-[150px]">
      ...
      <div className="fixed right-0 left-0 bottom-[-50px] pt-[10px] mx-auto flex items-center bg-[#121214]">
